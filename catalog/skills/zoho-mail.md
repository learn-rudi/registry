...
description: "Operate Zoho Mail through RUDI's stack tools when a user asks for work supported by stack:zoho-mail. Zoho Mail tools for OAuth accounts, folder and message search, email send, draft, reply, deletion, threads, and attachments"
version: 1.0.0
