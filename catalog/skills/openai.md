...
description: "Operate OpenAI Suite through RUDI's stack tools when a user asks for work supported by stack:openai. OpenAI tools: DALL-E images, Whisper transcription, TTS speech, Sora video"
version: 1.0.0
