...
description: "Operate Google AI Suite through RUDI's stack tools when a user asks for work supported by stack:google-ai. Generate images (Gemini, Imagen 4) and videos (Veo 3.1) using Google AI"
version: 1.0.0
...
# Google AI Suite Operator

Use this skill as the host-native operating layer for `stack:google-ai`.
Translate the user's intent into the smallest safe sequence of stack tool calls,
then verify and report the result.

## When To Use

Generate images (Gemini, Imagen 4) and videos (Veo 3.1) using Google AI
...
- Missing stack or tools: stop and ask the user to install, index, or integrate
  `stack:google-ai`; do not simulate a successful tool call.
