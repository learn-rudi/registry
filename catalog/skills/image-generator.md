...
description: "Operate Image Generator through RUDI's stack tools when a user asks for work supported by stack:image-generator. Agent-safe API and bounded Midjourney browser image generation for content creation workflows."
version: 1.0.0
