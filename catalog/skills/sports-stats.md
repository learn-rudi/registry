...
description: "Operate Sports Stats through RUDI's stack tools when a user asks for work supported by stack:sports-stats. Extract and query sports statistics from Basketball Reference, ESPN, and other sports sites"
version: 1.0.0
