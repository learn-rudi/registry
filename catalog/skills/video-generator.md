...
description: "Operate Video Generator through RUDI's stack tools when a user asks for work supported by stack:video-generator. Agent-safe multi-provider video generation for content creation workflows."
version: 1.0.0
