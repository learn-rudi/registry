...
2. Treat sent mail as the source of truth for whether the account owner or their team has replied.
...
- `Needs Reply`: a real person appears to be waiting on the account owner or their team.
- `Waiting`: the account owner or their team replied or acted, and the next step belongs to someone else.
