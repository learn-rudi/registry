...
description: "Operate Otter MCP through RUDI's stack tools when a user asks for work supported by stack:otter-mcp. Search and fetch Otter meeting transcripts through Otter's hosted OAuth MCP server."
version: 1.0.0
