...
description: "Operate Agent Hosts through RUDI's stack tools when a user asks for work supported by stack:agent-hosts. Governed synchronous MCP gateway for a fixed local DeepSeek, Claude Code, and Codex Agent Host fleet."
version: 1.0.0
