...
description: "Operate Document Processor through RUDI's stack tools when a user asks for work supported by stack:document-processor. Extract PDF slides as images, remove watermarks, and process presentations."
version: 1.0.0
