---
name: "Slack Operator"
description: "Operate Slack through RUDI's stack tools when a user asks for work supported by stack:slack. Send messages, search channels, upload files, and manage reactions in Slack"
version: 1.0.0
