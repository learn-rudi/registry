...
description: "Operate Twilio SMS through RUDI's stack tools when a user asks for work supported by stack:twilio-sms. Send SMS messages and inspect recent Twilio messages through a guarded MCP interface."
version: 1.0.0
