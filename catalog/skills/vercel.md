...
description: "Operate Vercel through RUDI's stack tools when a user asks for work supported by stack:vercel. Deploy to Vercel, manage environment variables, and monitor deployments"
version: 1.0.0
category: "deployment"
tags:
  - rudi
...
Use this skill as the host-native operating layer for `stack:vercel`.
...
- Missing stack or tools: stop and ask the user to install, index, or integrate
  `stack:vercel`; do not simulate a successful tool call.
