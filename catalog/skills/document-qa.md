...
description: "Operate Document QA through RUDI's stack tools when a user asks for work supported by stack:document-qa. Visual QA inspection for HTML documents using screenshots and Claude Vision."
version: 1.0.0
