---
name: "Cloudinary Operator"
description: "Operate Cloudinary through RUDI's stack tools when a user asks for work supported by stack:cloudinary. Upload local media to Cloudinary and return public HTTPS URLs for social publishing workflows."
version: 1.0.0
category: "media"
tags:
  - rudi
...
Use this skill as the host-native operating layer for `stack:cloudinary`.
Translate the user's intent into the smallest safe sequence of stack tool calls,
then verify and report the result.

## When To Use

Upload local media to Cloudinary and return public HTTPS URLs for social publishing workflows.
...
- Missing stack or tools: stop and ask the user to install, index, or integrate
  `stack:cloudinary`; do not simulate a successful tool call.
