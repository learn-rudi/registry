---
name: "Newsletter Extractor Operator"
description: "Operate Newsletter Extractor through RUDI's stack tools when a user asks for work supported by stack:newsletter-extractor. Extract newsletter email bodies, normalize newsletter links, and read RSS/Atom feeds"
version: 1.0.0
...
requires:
  stacks:
    - stack:newsletter-extractor
---

# Newsletter Extractor Operator

Use this skill as the host-native operating layer for `stack:newsletter-extractor`.
Translate the user's intent into the smallest safe sequence of stack tool calls,
then verify and report the result.

## When To Use

Extract newsletter email bodies, normalize newsletter links, and read RSS/Atom feeds
...
- Missing stack or tools: stop and ask the user to install, index, or integrate
  `stack:newsletter-extractor`; do not simulate a successful tool call.
