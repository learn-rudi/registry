...
description: "Operate RUDI Processor through RUDI's stack tools when a user asks for work supported by stack:rudi-processor. Local file metadata extraction, workspace audit, and indexed content search."
version: 1.0.0
