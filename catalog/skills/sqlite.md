...
description: "Operate SQLite through RUDI's stack tools when a user asks for work supported by stack:sqlite. Query and manage SQLite databases. Perfect for local databases, app data, and the RUDI session database."
version: 1.0.0
category: "data"
tags:
  - rudi
...
Query and manage SQLite databases. Perfect for local databases, app data, and the RUDI session database.
