...
description: "Operate Tally Forms through RUDI's stack tools when a user asks for work supported by stack:tally. Create, manage, and analyze Tally forms and submissions"
version: 1.0.0
