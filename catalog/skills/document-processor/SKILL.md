---
name: "Document Processor Operator"
description: "Extract PDF slides as images, remove watermarks, and process presentations."
version: 1.0.1
category: "documents"
tags:
  - rudi
...
requires:
  stacks:
    - stack:document-processor
---

# Document Processor Operator

Use this skill as the host-native operating layer for `stack:document-processor`.
...
Use this stack to transform an accepted PDF or presentation into page/slide images
and for specifically requested watermark processing. Confirm page range and output
location, preserve the original, and check output count, order and legibility.
Use MS Office for Word/Excel content extraction, web-export for HTML-to-PDF/PNG
rendering, and document-qa for visual inspection. These are distinct operations;
choose a companion only when the requested deliverable needs it.
...
- Missing stack or tools: stop and ask the user to install, index, or integrate
  `stack:document-processor`; do not simulate a successful tool call.
