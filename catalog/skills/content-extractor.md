...
description: "Operate Content Extractor through RUDI's stack tools when a user asks for work supported by stack:content-extractor. Extract content from YouTube, Reddit, TikTok, web articles, GitHub, and link batches"
version: 1.0.0
