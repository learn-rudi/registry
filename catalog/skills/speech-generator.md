...
description: "Operate Speech Generator through RUDI's stack tools when a user asks for work supported by stack:speech-generator. Validated multi-provider text-to-speech generation with OpenAI, ElevenLabs, and Gemini."
version: 1.0.0
