...
import { validateAnswerBasis, validateCheckpointAnswers, validateDiscoveryFailure, validateDiscoveryResult } from "./discovery-ledger-inputs.mjs";
...
import {
  ...
  isoTimestamp,
  requireActiveLease,
  requireExpiredActiveLease
} from "./discovery-ledger-leases.mjs";
