...
const MAXIMUM_PROVIDER_PROJECTS = 48;
const MAXIMUM_ZONES_PER_USE = 2;
const MINIMUM_PRIORITY_SCORE = 30;
const REQUIRED_SAMPLING_STRATA = [
...
function validateAdaptivePolicy(value, catalog) {
  exactRecord(value, [
