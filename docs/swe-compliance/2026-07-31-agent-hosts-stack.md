...
- Implementation rules:
  ...
  - [x] Add no dependency beyond an exact `@modelcontextprotocol/sdk` pin, with an integrity lock. The integrated package uses `1.30.0` to include the upstream DNS-rebinding fix for GHSA-w48q-cv73-mx4w.
